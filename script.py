...
import sys
load_dotenv()
PINECONE_API_KEY=os.environ.get('PINECONE_API_KEY','3c244373-c13c-4b8b-b49f-bd47d2701f47')
PINECONE_API_ENV=os.environ.get('PINECONE_API_ENV', 'us-east-1-gcp-free')
